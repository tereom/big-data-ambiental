...
La interpretación anterior de la probabilidad es fundamental, pero deja sin 
...
En muchos casos, el modelo equiprobable (discreto o continuo) no es tan fácil de
adaptar a problemas particulares de modelación probabilística. Por ejemplo:
...
Pensemos en el caso de un dardo univariado. En este caso, la probabilidad
...
Hasta ahora hemos visto ejemplos de distribuciones univariadas, 
