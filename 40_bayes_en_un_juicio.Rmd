...
$$
¿Le ponemos números? Veamos un caso en el que se localizan rastros de sangre de un presunto homicida en la escena de un crimen. El análisis forense encuentra que este tipo de sangre se puede encontrar en $\frac{1}{15,000}$ personas en la población de referencia. Con base en este dato podemos calcular el mommio de que se presente la evidencia, considerando que ya sabemos que el culpable tiene ese tipo de sangre, por lo tanto lo conocemos con probabilidad 1:
...
$$ 
lo que permite calcular la probabilidad de ser culpable a la luz de la evidencia, en este caso: `r round(o_evidencia_culpable/(1+o_evidencia_culpable),4) * 100`%. ¿Qué cabría decidir en el juicio?
...
o_evidencia_culpable
```
En este otro escenario el presunto asesino tiene un momio de `r o_evidencia_culpable` en su contra y por lo tanto, la nueva probabilidad de ser culpable a la luz de la evidencia es: `r round(o_evidencia_culpable/(1+o_evidencia_culpable),4) * 100`%. ¿Qué cabría decidir ahora en el juicio?


[Lecturas complementaria](https://www.r-bloggers.com/bayesian-blood/)
