...
Por lo tanto, el presunto asesino tiene un momio de `r o_culpable_evidencia` en su contra.
...
o_evidencia_culpable
```
En este otro escenario el presunto asesino tiene un momio de `r o_culpable_evidencia` en su contra y por lo tanto, la nueva probabilidad de ser culpable a la luz de la evidencia es: `r format(o_culpable_evidencia/(1+o_culpable_evidencia) * 100, digits=4)`%. ¿Qué cabría decidir ahora en el juicio?
